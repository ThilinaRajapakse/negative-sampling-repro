...
model_type = "custom"
model_name = None
context_name = "../../trained_models/pretrained/DPR-BM-msmarco/context_encoder"
question_name = "../../trained_models/pretrained/DPR-BM-msmarco/query_encoder"

# Setting up the Weights & Biases run name
model_args.wandb_kwargs = {"name": f"DPR-BM-tydi"}

# Setting up the output directory for saving the trained model
model_args.output_dir = f"../../trained_models/finetuned/DPR-BM-tydi"
