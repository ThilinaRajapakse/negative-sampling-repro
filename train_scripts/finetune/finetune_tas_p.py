...
model_args.output_dir = f"../../trained_models/finetuned/TAS-passage-tydi"
model_args.wandb_kwargs = {"name": f"TAS-passage-tydi"}
...
model_type = "custom"
model_name = None
context_name = "../../trained_models/pretrained/TAS-passage-msmarco/context_encoder"
question_name = "../../trained_models/pretrained/TAS-passage-msmarco/query_encoder"
