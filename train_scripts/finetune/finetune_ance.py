...
model_type = "custom"
model_name = None
context_name = "../../trained_models/pretrained/ANCE-msmarco/context_encoder"
question_name = "../../trained_models/pretrained/ANCE-msmarco/query_encoder"
...
model_args.wandb_kwargs = {"name": f"ANCE-tydi"}

# Setting up the output directory for saving the trained model
model_args.output_dir = f"../../trained_models/finetuned/ANCE-tydi"
