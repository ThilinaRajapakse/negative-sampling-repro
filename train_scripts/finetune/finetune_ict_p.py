...
model_args.output_dir = f"../../trained_models/finetuned/ICT-passage-tydi"
model_args.wandb_kwargs = {"name": f"ICT-passage-tydi"}

# Define the model type and names
model_type = "custom"
model_name = None
context_name = "../../trained_models/pretrained/ICT-passage-msmarco/context_encoder"
question_name = "../../trained_models/pretrained/ICT-passage-msmarco/query_encoder"
