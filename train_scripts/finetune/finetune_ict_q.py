...
model_args.output_dir = f"../../trained_models/finetuned/ICT-query-tydi"
model_args.wandb_kwargs = {"name": f"ICT-query-tydi"}
...
model_type = "custom"
model_name = None
context_name = "../../trained_models/pretrained/ICT-query-msmarco/context_encoder"
question_name = "../../trained_models/pretrained/ICT-query-msmarco/query_encoder"
