...
model_args.output_dir = f"../../trained_models/finetuned/TAS-query-tydi"
model_args.wandb_kwargs = {"name": f"TAS-query-tydi"}
...
model_type = "custom"
model_name = None
context_name = "../../trained_models/pretrained/TAS-query-msmarco/context_encoder"
question_name = "../../trained_models/pretrained/TAS-query-msmarco/query_encoder"
